...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.1]{figures/ECE_1985_real_idf_blindern.png.png}
    \caption{A caption.}
...
\makebox[\linewidth][c]{%
\centering
\subfigure[Caption]{\includegraphics[width=0.6\textwidth]{figures/ECE_1985_idf_Blindern_2_20_200.png}}%
\subfigure[Caption]{\includegraphics[width=0.6\textwidth]{figures/ECE_1985_idf_Besserud_2_20_200.png}}%
}
\caption{my caption}
